...
export default function Home() {
  return (
    <div className="">
      ...
      <div className='flex flex-wrap justify-center py-[10%] md:py-[5%] px-[20%] bg-[#3d020f]'>
        ...
        <div className='mb-[3%] text-[12px] md:text-[16px]'>
          <div className='flex flex-wrap text-justify text-white'>
            <div className="flex gap-5">
              ...
              <Link className="flex items-center" href="/about#history">
                <div className="flex items-center justify-start text-[#fa0334] gap-2">
        ...
        <div className='mb-[3%] text-[12px] md:text-[16px]'>
          <div className='flex flex-wrap justify-end text-justify text-white'>
            <div className="flex gap-5">
              <Link className="flex items-center" href="/teams">
                <div className="flex items-center justify-start text-[#fa0334] gap-2">
        ...
        <div className='mb-[3%] text-[12px] md:text-[16px]'>
          <div className='flex flex-wrap text-justify text-white'>
            <div className="flex gap-5">
              ...
              <Link className="flex items-center" href="/about#about">
                <div className="flex items-center justify-start text-[#fa0334] gap-2">
